    ...
    def get_bimetallic_label_dict(self): 
        ...
        if self.surface in ['fcc111','hcp0001']:
            ...
            return {'ontop|step|{}'.format(ma): 1, 
                    ...
                    'bridge|h|{}{}'.format(ma,mb): 12,
                    'bridge|h|{}{}'.format(mb,mb): 13, 
                    '3fold|h|{}{}{}'.format(ma,ma,ma): 14,
                    '3fold|h|{}{}{}'.format(ma,ma,mb): 15, 
                    '3fold|h|{}{}{}'.format(ma,mb,mb): 16,
                    '3fold|h|{}{}{}'.format(mb,mb,mb): 17,
                    '4fold|subsurf|{}{}-{}{}'.format(ma,ma,ma,ma): 18,
                    '4fold|subsurf|{}{}-{}{}'.format(ma,ma,ma,mb): 19,
                    '4fold|subsurf|{}{}-{}{}'.format(ma,ma,mb,mb): 20,
                    '4fold|subsurf|{}{}-{}{}'.format(ma,mb,ma,ma): 21,
                    '4fold|subsurf|{}{}-{}{}'.format(ma,mb,ma,mb): 22,
                    '4fold|subsurf|{}{}-{}{}'.format(ma,mb,mb,mb): 23,
                    '4fold|subsurf|{}{}-{}{}'.format(mb,mb,ma,ma): 24,
                    '4fold|subsurf|{}{}-{}{}'.format(mb,mb,ma,mb): 25,
                    '4fold|subsurf|{}{}-{}{}'.format(mb,mb,mb,mb): 26,
                    # neighbor elements count clockwise from shorter bond ma
                    '5fold|subsurf|{}-{}{}{}{}'.format(ma,ma,ma,ma,ma): 27,
                    '5fold|subsurf|{}-{}{}{}{}'.format(ma,ma,ma,ma,mb): 28,
                    '5fold|subsurf|{}-{}{}{}{}'.format(ma,ma,ma,mb,mb): 29,
                    '5fold|subsurf|{}-{}{}{}{}'.format(ma,ma,mb,ma,mb): 30,
                    '5fold|subsurf|{}-{}{}{}{}'.format(ma,ma,mb,mb,mb): 31, 
                    '5fold|subsurf|{}-{}{}{}{}'.format(ma,ma,mb,mb,mb): 32,
                    '5fold|subsurf|{}-{}{}{}{}'.format(ma,mb,mb,mb,mb): 33,
                    '5fold|subsurf|{}-{}{}{}{}'.format(mb,ma,ma,ma,ma): 34,
                    '5fold|subsurf|{}-{}{}{}{}'.format(mb,ma,ma,ma,mb): 35,
                    '5fold|subsurf|{}-{}{}{}{}'.format(mb,ma,ma,mb,mb): 36,
                    '5fold|subsurf|{}-{}{}{}{}'.format(mb,ma,mb,ma,mb): 37,
                    '5fold|subsurf|{}-{}{}{}{}'.format(mb,ma,mb,mb,ma): 38,
                    '5fold|subsurf|{}-{}{}{}{}'.format(mb,ma,mb,mb,mb): 39,
                    '5fold|subsurf|{}-{}{}{}{}'.format(mb,mb,mb,mb,mb): 40}
