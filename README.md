...
```
<img src="images/tagged_sites.png"  width="700" height="300">
...
2. Please provide surface structures that have at least 8 surface atoms for 100 facet and at least 4 surface atoms for 111 facet. In this code, the indices that constitute a surface site must be all unique, so a 4-fold hollow site requires at least 8 surface atoms for a 100 facet and a 3-fold hollow site requires at least 4 surface atoms for a 111 facet. The ```monometallic_add_adsorbate``` function still works for 100 facets with less than 8 surface atoms and 111 facets with less than 4 surface atoms, but other functions do not work. Nanoparticles have no such issues.