...
structures = read('NiPt3_311_2_emt.traj', index=':')
# Write output trajectory of the current generation
traj = Trajectory('NiPt3_311_3_emt.traj', mode='a')
...
Ecutoff = 2.25 # Set a very large cutoff for the 1st generation
starting_images = []
old_labels_list = []
old_graph_list = []
